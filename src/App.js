...
function App() {
  ...
  const [product, setProduct] = useState([
    {
      url: 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fmotorbikewriter.com%2Fsegway-plans-hydrogen-sports-bike%2F&psig=AOvVaw2WypyP-uaTHVpwmeaVJ-Dp&ust=1665831381786000&source=images&cd=vfe&ved=0CA0QjRxqFwoTCOiRmM7H3_oCFQAAAAAdAAAAABAE',
      name: 'Hydrogen Sports Bike',
      category: 'Bike',
      seller: 'YanshanshSportsClub',
      price: 1999
    },
    {
